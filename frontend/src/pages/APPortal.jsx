      ...
      <div className="ss-page-header">
        <div className="ss-page-header-left">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 7 }}>
            <h4 className="ss-page-title" style={{ margin: 0 }}>Accounts Payable</h4>
            <span className="ss-info-tip" data-tip="Vendor payables, aging analysis, and payment management">
